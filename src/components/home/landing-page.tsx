...
import { ArrowRight, CalendarBlank, Play, Quotes, Star, TrendUp, UsersThree, Wrench } from 'phosphor-react';
import styles from './landing-page.module.scss';

const featureItems = [
  {
    icon: '/theme/images/icon/pipe.png',
    title: 'Quick Repairs',
    active: false,
  },
  {
    icon: '/theme/images/icon/water-tap.png',
    title: 'Emergency Help',
    active: true,
  },
  {
    icon: '/theme/images/icon/remodeling.png',
    title: 'Clean Finish',
    active: false,
  },
] as const;
...
const serviceItems = [
  {
    ...
    description: 'Same-day leak repair for kitchens, bathrooms, and hidden utility lines.',
  },
  {
    image: '/theme/images/service/2.jpg',
    title: 'Water heater support',
    description: 'Trusted diagnostics, replacement guidance, and emergency hot water repair.',
  },
  {
    image: '/theme/images/service/3.jpg',
    title: 'Bathroom remodeling',
    description: 'From fixtures to tiling, find vetted specialists for complete upgrades.',
  },
] as const;
...
const testimonialItems = [
  {
    quote: 'NearHelp made it easy to compare real pros. We booked same-day service and the work quality was excellent.',
    name: 'Hannah Seo',
    role: 'Apartment owner',
    image: '/theme/images/testimonial/img-1.jpg',
  },
  {
    quote: 'The platform saved us during an emergency leak. Messaging, booking, and updates all felt smooth and trustworthy.',
    name: 'Minho Choi',
    role: 'Property manager',
    image: '/theme/images/testimonial/img-2.jpg',
  },
  {
    quote: 'I liked how clear the pricing guidance and reviews were. It felt much easier than calling random contractors.',
    name: 'Sora Lim',
    role: 'Homeowner',
...
const workItems = [
  {
    ...
    icon: <UsersThree size={38} weight="duotone" />,
    href: '/agents',
    accent: false,
  },
  {
    title: 'Book online in minutes',
    icon: <CalendarBlank size={38} weight="duotone" />,
    href: '#booking',
    accent: true,
  },
] as const;
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        <div className={styles.heroBackground}>
          <Image src="/theme/images/slider/slide-1.jpg" alt="Plumbing background" fill priority className={styles.heroBgImage} />
        </div>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.heroDescription}>
              NearHelp connects homeowners with trusted specialists for plumbing, gas, electricity,
              remodeling, and clean-up work across Seoul.
            </p>
            <div className={styles.heroActions}>
              <Link href="#booking" className={styles.primaryButton}>
                BOOK ONLINE
              </Link>
              <button type="button" className={styles.playButton} aria-label="Play intro video">
        ...
        <div className={styles.container}>
          <div className={styles.featuresGrid}>
            {featureItems.map((item) => (
              ...
              >
                <Image src={item.icon} alt={item.title} width={82} height={82} className={styles.featureIcon} />
                <h3>{item.title}</h3>
              </div>
            ))}
          </div>
      ...
      <section className={styles.serviceSection}>
        <div className={styles.container}>
          <div className={styles.sectionIntro}>
            ...
            <h2>Reliable home service support for urgent fixes and planned upgrades.</h2>
          </div>
          <div className={styles.serviceGrid}>
            {serviceItems.map((item) => (
              <article key={item.title} className={styles.serviceCard}>
                <div className={styles.serviceImageWrap}>
                  <Image src={item.image} alt={item.title} width={520} height={360} className={styles.serviceImage} />
                </div>
        ...
        <div className={styles.container}>
          <div className={styles.factsLayout}>
            <div className={styles.factsCopy}>
              <h2>Thousands of homeowners trust NearHelp when the job cannot wait.</h2>
          ...
          <div className={styles.projectGrid}>
            {projectItems.map((item) => (
              <article key={item.title} className={styles.projectCard}>
                <Image src={item.image} alt={item.title} width={480} height={420} className={styles.projectImage} />
      ...
      <section className={styles.teamSection}>
        <div className={styles.container}>
          <div className={styles.sectionIntroCenter}>
            ...
            <h2>Meet specialists customers repeatedly trust for urgent and premium jobs.</h2>
          </div>
          <div className={styles.teamGrid}>
            {agentItems.map((item) => (
              <article key={item.name} className={styles.teamCard}>
                <Image src={item.image} alt={item.name} width={420} height={420} className={styles.teamImage} />
      ...
      <section className={styles.contactSection} id="booking">
        <div className={styles.contactMedia}>
          <Image src="/theme/images/contact.jpg" alt="Online booking" fill className={styles.contactImage} />
          <button type="button" className={styles.videoButton} aria-label="Play booking intro">
          ...
          <div className={styles.contactLayout}>
            <div className={styles.contactFormCard}>
              ...
              <form className={styles.contactForm}>
                ...
                <textarea rows={5} placeholder="Describe the issue you need help with" />
        ...
        <div className={styles.container}>
          <div className={styles.testimonialLayout}>
            <div className={styles.testimonialIntro}>
              ...
              <h2>Customers come back because the experience feels fast, clear, and reliable.</h2>
              <p>
                NearHelp combines real reviews, direct messaging, and smooth booking so users can choose with
              ...
              {testimonialItems.map((item) => (
                <article key={item.name} className={styles.testimonialCard}>
                  ...
                  <div className={styles.testimonialAuthor}>
                    <Image src={item.image} alt={item.name} width={70} height={70} className={styles.authorImage} />
                    <div>
                      <h3>{item.name}</h3>
                      <span>{item.role}</span>
                    </div>
      ...
      <section className={styles.blogSection}>
        <div className={styles.container}>
          <div className={styles.sectionIntroCenter}>
            ...
            <h2>Helpful articles, practical tips, and project stories from the NearHelp network.</h2>
          </div>
          <div className={styles.blogGrid}>
            {blogItems.map((item) => (
              <article key={item.title} className={styles.blogCard}>
                <Image src={item.image} alt={item.title} width={480} height={300} className={styles.blogImage} />
